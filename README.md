...
<ul>
    ...
    <li>
        <b>Jump Search</b> - Atlamalı arama doğrusal aramaya göre daha hızlı, ikili aramaya göre daha yavaş kalan ve sıralı veri setleri üzerinde çalışan bir arama algoritmasıdır. Temel fikir, sabit adımlarla ileriye atlayarak, dizinin tüm elemanlarını aramak yerine bazı elemanları atlayarak (doğrusal aramaya göre)daha az elemanı kontrol etmektir.<img src="https://github.com/zumrudu-anka/Algorithms/blob/master/Presentation/jump-search-1.jpg" alt="Jump Search"/>
    </li>
    <li>
